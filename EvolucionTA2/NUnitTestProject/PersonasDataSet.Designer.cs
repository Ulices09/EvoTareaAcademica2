...
namespace NUnitTestProject {
    ...
    public partial class PersonasDataSet : global::System.Data.DataSet {
        ...
        public partial class PersonaDataTable : global::System.Data.TypedTableBase<PersonaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PersonaRow AddPersonaRow(string Nombre, string Apellido) {
...
namespace NUnitTestProject.PersonasDataSetTableAdapters {
    ...
    public partial class PersonaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Persona` WHERE ((`Codigo` = ?) AND ((? = 1 AND `Nombre` IS NULL) OR " +
                "(`Nombre` = ?)) AND ((? = 1 AND `Apellido` IS NULL) OR (`Apellido` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Persona` (`Nombre`, `Apellido`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Persona` SET `Nombre` = ?, `Apellido` = ? WHERE ((`Codigo` = ?) AND ((? =" +
                " 1 AND `Nombre` IS NULL) OR (`Nombre` = ?)) AND ((? = 1 AND `Apellido` IS NULL) " +
                "OR (`Apellido` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::NUnitTestProject.Properties.Settings.Default.PersonasConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Codigo, Nombre, Apellido FROM Persona";
        ...
        public virtual int Fill(PersonasDataSet.PersonaDataTable dataTable) {
        ...
        public virtual PersonasDataSet.PersonaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PersonasDataSet.PersonaDataTable dataTable = new PersonasDataSet.PersonaDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PersonasDataSet.PersonaDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Codigo, string Original_Nombre, string Original_Apellido) {
        ...
        public virtual int Update(string Nombre, string Apellido, int Original_Codigo, string Original_Nombre, string Original_Apellido) {
            if ((Nombre == null)) {
